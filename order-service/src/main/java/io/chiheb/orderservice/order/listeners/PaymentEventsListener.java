package io.chiheb.orderservice.order.listeners;

import io.chiheb.orderservice.order.OrderService;
import io.chiheb.orderservice.order.listeners.events.PaymentConfirmationEvent;
import io.chiheb.orderservice.order.listeners.events.PaymentRejectionEvent;
...
import static io.chiheb.orderservice.common.configs.KafkaConfig.ORDER_PAYMENT_CONFIRM_TOPIC;
import static io.chiheb.orderservice.common.configs.KafkaConfig.ORDER_PAYMENT_REJECT_TOPIC;
import static io.chiheb.orderservice.order.domain.OrderStatus.CANCELLED_PAYMENT_REJECTED;
import static io.chiheb.orderservice.order.domain.OrderStatus.PAYED_PREPARING_FOR_SHIPMENT;
