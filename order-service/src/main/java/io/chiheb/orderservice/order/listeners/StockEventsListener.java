...
import io.chiheb.orderservice.order.listeners.events.StockConfirmationEvent;
import io.chiheb.orderservice.order.listeners.events.StockRejectionEvent;
...
import static io.chiheb.orderservice.common.configs.KafkaConfig.ORDER_STOCK_CONFIRM_TOPIC;
import static io.chiheb.orderservice.common.configs.KafkaConfig.ORDER_STOCK_REJECT_TOPIC;
import static io.chiheb.orderservice.order.domain.OrderStatus.CANCELLED_OUT_OF_STOCK;
import static io.chiheb.orderservice.order.domain.OrderStatus.RESERVED_PROCESSING_PAYMENT;
