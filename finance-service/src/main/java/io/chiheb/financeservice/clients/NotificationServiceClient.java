package io.chiheb.financeservice.notification.clients;

import io.chiheb.financeservice.finance.domain.Invoice;
import io.chiheb.financeservice.notification.clients.events.OrderCancellationEvent;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.springframework.kafka.core.KafkaTemplate;
import org.springframework.stereotype.Component;

import static io.chiheb.financeservice.common.config.KafkaConfig.NOTIFICATION_ORDER_CANCELLED_TOPIC;
import static io.chiheb.financeservice.common.config.KafkaConfig.NOTIFICATION_ORDER_PAYED_TOPIC;
